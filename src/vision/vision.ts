import {VISION_HALF_ANGLE,VISION_RANGE} from './config'; import {angleBetween,distance} from '../core/math'; import type {Vec2} from '../core/types'; import type {Rect} from '../navigation/grid';
