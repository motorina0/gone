...
export interface Manifest{id:string;name:string;world:string;environment:string;mission:string;entityScale:number;navigation:{walkable:string;blockers:string;visionBlockers:string};entities:string[];patrols:string[];interactions:Record<string,string>;projections:string[];views:string[];occlusion:string[];detailOverlays:string[]}
