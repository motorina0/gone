...
- `gameplay-authoring.json`: editable, explicitly documented decisions for the source-supported octagonal render footprint, forecourt, legitimate mapped crossings and platform links, approximate vertical access and canopies, relative station elevations, and known approximations.
