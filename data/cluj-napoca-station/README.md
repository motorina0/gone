...
- `gameplay-authoring.json`: editable, explicitly documented decisions for the source-supported octagonal render footprint, forecourt, vehicle/tram walkability policy, legitimate mapped railway crossings and platform links, approximate vertical access and canopies, relative station elevations, and known approximations.
